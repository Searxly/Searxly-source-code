//
//  Known-answer tests for the security boundary: what a user is shown before approving a
//  signature/transaction, and the prompt-injection guard for "summarize page". Exits non-zero on failure.
//
import Foundation
...
print("\n[2] TypedDataPreview — chain-mismatch flagging")
...
print("\n[5] TypedDataPreview — raw keys shown when the type table is incomplete")
let opaque = """
